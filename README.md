...
**Инженерные и производственные системы:** `1С:ERP` · `КОМПАС-3D` · `ChemDraw` и другие инженерные CAD-программы

---

## 📂 Проекты

### [🍽️ Анализ рынка общественного питания Москвы](https://github.com/annadengina1106-cpu/restaurants_market_analysis)
Исследовательский анализ рынка общепита: категории заведений, распределение по округам, сетевой формат, посадочные места, рейтинги и их связь с ценой, топ популярных сетей, средний чек по округам. Рекомендации по открытию нового заведения.
**Стек:** Python, pandas, seaborn, phik, Jupyter Notebook

### [💰 Анализ рынка стартапов](https://github.com/annadengina1106-cpu/startup-market-analysis)
Исследовательский анализ рынка стартапов: динамика финансирования по годам и сегментам, поиск выбросов методом IQR, сравнение типов финансирования по объёму и возвратам, рекомендация по отрасли и типу финансирования для инвестиций. Стек: Python, pandas, numpy, matplotlib, Jupyter Notebook
...
🔗 [Дашборд](https://datalens.yandex/oee0exghnh7q7?_share_link=public)
...
- [TED-конференции](https://datalens.yandex/h5u435hayt1w0?_share_link=public)
